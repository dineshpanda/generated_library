Rails.application.routes.draw do
  ...
  post("/create_photo_from_book", { :controller => "photos", :action => "create_row_from_book" })
  ...
  post("/create_visitor_entry_from_book", { :controller => "visitor_entries", :action => "create_row_from_book" })
